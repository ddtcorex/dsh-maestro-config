...
// picks elements this panel does not declare, so the Maestro settings fields would render
// 2-3px larger than the labels and helper text beside them. The panel opts its own fields
// out of the floor and keeps the type scale it was designed with.
...
describe('Maestro settings panel opts out of the iOS field floor', () => {
