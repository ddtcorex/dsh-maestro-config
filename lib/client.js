...
function PlaceholderMappingsEditor({ rows, onChange }) {
  ...
  return (0, import_react.createElement)(
    ...
    (0, import_react.createElement)(
      ...
      (0, import_react.createElement)(Button, { variant: "primary", size: "md", onClick: addRow }, "+ Add mapping")
    ),
    rows.length === 0 ? (0, import_react.createElement)(
      "div",
      {
      ...
      ...rows.map(
        (row, i) => (0, import_react.createElement)(
          ...
          (0, import_react.createElement)("span", { "aria-hidden": true, style: { color: t.labelTertiary, flex: "none", fontSize: 13 } }, "\u2192"),
          (0, import_react.createElement)(FieldInput, {
